...
className="text-center py-2 border border-green-600 text-green-600 rounded-lg"
...
className="text-center py-2 bg-green-600 text-white rounded-lg"
...
className="py-2 bg-emerald-700 text-white rounded-lg"
